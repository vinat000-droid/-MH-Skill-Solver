...
const _loadDB=loadDB;loadDB=async()=>{await _loadDB();renderWeaponKindPicker();const s=$('weaponKind');if(s)s.onchange=()=>{W.weaponKind=s.value;renderPickers();save();};};
loadDB();
